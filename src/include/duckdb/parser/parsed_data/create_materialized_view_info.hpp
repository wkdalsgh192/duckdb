...
struct CreateMaterializedViewInfo : public CreateInfo {
public:
	CreateMaterializedViewInfo();
	CreateMaterializedViewInfo(SchemaCatalogEntry &schema, string view_name);
	CreateMaterializedViewInfo(string catalog_p, string schema_p, string view_name);
...
public:
	...
	DUCKDB_API static unique_ptr<CreateMaterializedViewInfo> FromSelect(ClientContext &context,
	                                                                    unique_ptr<CreateMaterializedViewInfo> info);
	//! Gets a bound CreateViewInfo object from a CREATE VIEW statement
	DUCKDB_API static unique_ptr<CreateMaterializedViewInfo> FromCreateView(ClientContext &context, const string &sql);
